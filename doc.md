---
title: How to Create a Rail Radar API Key
description: Step-by-step guide to registering for a Rail Radar API key and accessing the service.
---
...
2. Use the API key in your requests to authenticate with Rail Radar's services.  
   Example request format:  
   ```http
   GET https://api.railradar.in/v1/trains?apikey=YOUR_API_KEY
